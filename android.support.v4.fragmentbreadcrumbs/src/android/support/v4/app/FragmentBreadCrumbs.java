...
public class FragmentBreadCrumbs extends ViewGroup
    ...
    public FragmentBreadCrumbs(Context context, AttributeSet attrs) {
        super(context, attrs, R.attr.fragmentBreadCrumbsStyle);
        
        initialize(context, attrs, R.attr.fragmentBreadCrumbsStyle, 0);
    }
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
    	final TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.FragmentBreadCrumbs, defStyleAttr, defStyleRes);
